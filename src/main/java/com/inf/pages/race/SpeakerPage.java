 ...
 */
public class SpeakerPage extends BasePage {
    ...
    @FindBy(css = "#speaker_form>#submit_phone") WebElement fBtn;
    @FindBy(css = "#fancybox-close") WebElement acceptClose;
    public SpeakerPage(WebDriver driver) throws Exception{
        super(driver);
        this.PAGE_URL = "http://race-expo.ru/ru/speakers/";
    ...
    public void cntnt() {
        verifyElementIsContainText(header, "СТАТЬ СПИКЕРОМ");
