...
public class Place extends BasePage{
    ...
    public Place(WebDriver driver) throws Exception {
        super(driver);
        this.PAGE_URL = "http://ukrainegaming.com.ua/uk/place";
        this.PAGE_TITLE = "Місце проведення | Ukrainian Gaming Congress";
    }
